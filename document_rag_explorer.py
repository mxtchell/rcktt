...
@skill(
    name="Reckitt Survey Explorer",
    description="ALWAYS use this skill FIRST for ANY question about: sex, sexual health, relationships, intimacy, lube, lubricant, virginity, satisfaction, consumer behavior, survey data, global trends, or demographics. This skill searches the Reckitt Global Sex Survey research data.",
    capabilities="Searches Reckitt Global Sex Survey data: sexual health insights, relationship statistics, demographic trends, consumer attitudes, product usage data. Returns factual answers with citations.",
    limitations="Limited to Reckitt Global Sex Survey data in the knowledge base.",
    parameters=[
        SkillParameter(
            name="user_question",
        ...
        SkillParameter(
            ...
            required=True,
            default_value="https://reckitt.poc.answerrocket.com/apps/system/knowledge-base"
        ),
        SkillParameter(
            name="max_sources",
